...
{	
	...
	{	
		...
		if(TFCMOptions.enableCraftingLongbow = true)
		{
			...
			//Halberds 3 ingots
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot2x), new ItemStack(TFCItems.bismuthBronzeIngot), PlanNameHalberd, AnvilReq.BRONZE, new ItemStack(TFCMItems.halberd_BismuthBronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot2x), new ItemStack(TFCItems.blackBronzeIngot), PlanNameHalberd, AnvilReq.BRONZE, new ItemStack(TFCMItems.halberd_BlackBronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot2x), new ItemStack(TFCItems.blackSteelIngot), PlanNameHalberd, AnvilReq.BLACKSTEEL, new ItemStack(TFCMItems.halberd_BlackSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelIngot2x), new ItemStack(TFCItems.blueSteelIngot), PlanNameHalberd, AnvilReq.BLUESTEEL, new ItemStack(TFCMItems.halberd_BlueSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeIngot2x), new ItemStack(TFCItems.bronzeIngot), PlanNameHalberd, AnvilReq.BRONZE, new ItemStack(TFCMItems.halberd_Bronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperIngot2x), new ItemStack(TFCItems.copperIngot), PlanNameHalberd, AnvilReq.COPPER, new ItemStack(TFCMItems.halberd_Copper_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelIngot2x), new ItemStack(TFCItems.redSteelIngot), PlanNameHalberd, AnvilReq.BLUESTEEL, new ItemStack(TFCMItems.halberd_RedSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelIngot2x), new ItemStack(TFCItems.steelIngot), PlanNameHalberd, AnvilReq.STEEL, new ItemStack(TFCMItems.halberd_Steel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), new ItemStack(TFCItems.wroughtIronIngot), PlanNameHalberd, AnvilReq.WROUGHTIRON, new ItemStack(TFCMItems.halberd_WroughtIron_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
			//War Hammers 3 ingots
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot2x), new ItemStack(TFCItems.bismuthBronzeIngot), PlanNameWarHammer, AnvilReq.BRONZE, new ItemStack(TFCMItems.warHammer_BismuthBronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot2x), new ItemStack(TFCItems.blackBronzeIngot), PlanNameWarHammer, AnvilReq.BRONZE, new ItemStack(TFCMItems.warHammer_BlackBronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot2x), new ItemStack(TFCItems.blackSteelIngot), PlanNameWarHammer, AnvilReq.BLACKSTEEL, new ItemStack(TFCMItems.warHammer_BlackSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelIngot2x), new ItemStack(TFCItems.blueSteelIngot), PlanNameWarHammer, AnvilReq.BLUESTEEL, new ItemStack(TFCMItems.warHammer_BlueSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeIngot2x), new ItemStack(TFCItems.bronzeIngot), PlanNameWarHammer, AnvilReq.BRONZE, new ItemStack(TFCMItems.warHammer_Bronze_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperIngot2x), new ItemStack(TFCItems.copperIngot), PlanNameWarHammer, AnvilReq.COPPER, new ItemStack(TFCMItems.warHammer_Copper_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelIngot2x), new ItemStack(TFCItems.redSteelIngot), PlanNameWarHammer, AnvilReq.BLUESTEEL, new ItemStack(TFCMItems.warHammer_RedSteel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelIngot2x), new ItemStack(TFCItems.steelIngot), PlanNameWarHammer, AnvilReq.STEEL, new ItemStack(TFCMItems.warHammer_Steel_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		anvilManager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), new ItemStack(TFCItems.wroughtIronIngot), PlanNameWarHammer, AnvilReq.WROUGHTIRON, new ItemStack(TFCMItems.warHammer_WroughtIron_Head, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
			//Poniards
