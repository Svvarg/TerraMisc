...
public class TFCMItems
{
	...
	public static Item BlueSteelChainGreaves;
	public static Item BronzeChainGreaves;
	public static Item CopperChainGreaves;
	...
	public static Item BlueSteelChainChestplate;
	public static Item BronzeChainChestplate;
	public static Item CopperChainChestplate;
	...
	public static Item BlueSteelChainHelmet;
	public static Item BronzeChainHelmet;
	public static Item CopperChainHelmet;
	...
	public static void registers()
	{
		...
		GameRegistry.registerItem(BlueSteelChainGreaves, BlueSteelChainGreaves.getUnlocalizedName());
		GameRegistry.registerItem(BronzeChainGreaves, BronzeChainGreaves.getUnlocalizedName());
		GameRegistry.registerItem(CopperChainGreaves, CopperChainGreaves.getUnlocalizedName());
		...
		GameRegistry.registerItem(BlueSteelChainChestplate, BlueSteelChainChestplate.getUnlocalizedName());
		GameRegistry.registerItem(BronzeChainChestplate, BronzeChainChestplate.getUnlocalizedName());
		GameRegistry.registerItem(CopperChainChestplate, CopperChainChestplate.getUnlocalizedName());
		...
		GameRegistry.registerItem(BlueSteelChainHelmet, BlueSteelChainHelmet.getUnlocalizedName());
		GameRegistry.registerItem(BronzeChainHelmet, BronzeChainHelmet.getUnlocalizedName());
		GameRegistry.registerItem(CopperChainHelmet, CopperChainHelmet.getUnlocalizedName());
