...
//Based on BlockHopper from TFC, couldn't extend BlockHopper due to visablity restrictions.

public class BlockFruitPress extends BlockTerraContainer
{
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack is)
	{
		...
		{
			TEFruitPress te = getHopperTE(world, x, y, z);
			te.setCustomName(is.getDisplayName());
		}
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		...
		else
		{
			...
			{
				player.openGui(TerraMisc.instance, 1, world, x, y, z);
			}
	...
	public static TEFruitPress getHopperTE(IBlockAccess access, int x, int y, int z)
	{
		return (TEFruitPress)access.getTileEntity(x, y, z);
	}
